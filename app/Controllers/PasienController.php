...
class PasienController extends BaseController
{
    ...
    public function tampilTambah()
    {
        $this->konfig = [
            ...
            [1, 'Nama Pasien', 'nm_pasien', 'nama', 1],
            [1, 'Tanggal Lahir', 'tgl_lahir', 'tanggal', 0],
            [1, 'Jenis Kelamin', 'jk', 'status', 1, [['L', 'Laki-laki'], ['P', 'Perempuan']]],
            [1, 'No. KTP/SIM', 'no_ktp', 'indeks', 0],
            [1, 'Tempat Lahir', 'tmp_lahir', 'nama', 0],
            [1, 'Alamat Pasien', 'alamat', 'teks', 1],
            [1, 'Golongan Darah', 'gol_darah', 'status', 0, [['A', 'A'], ['B', 'B'], ['AB', 'AB'], ['O', 'O']]],
            // ... urutkan form sesuai yang kamu inginkan
        ];
        return parent::tampilTambah();
    }
    ...
    public function tampilUbah($id)
    {
        $this->konfig = [
            ...
            [1, 'Alamat Pasien', 'alamat', 'teks', 1],
            [1, 'Golongan Darah', 'gol_darah', 'status', 0, [['A', 'A'], ['B', 'B'], ['AB', 'AB'], ['O', 'O']]],
            // ... urutkan ulang sesuai keinginan form
        ];
