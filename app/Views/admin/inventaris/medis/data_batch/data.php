                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-3 py-1.5 text-center inline-flex">
                                            ...
                                            <div class="px-3 py-1.5">
                                                ...
                                                <div id="modelConfirm-<?= $batch['no_batch'] . $batch['no_faktur'] . $batch['id_barang_medis'] ?>" class="fixed hidden z-[70] inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 ">
                                                    <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">

                                                        <div class="flex justify-end p-2">
                                                            <button onclick="closeModal('modelConfirm-<?= $batch['no_batch'] . $batch['no_faktur'] . $batch['id_barang_medis'] ?>')" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
                                                        ...
                                                        <div class="p-6 pt-0 text-center">
                                                            ...
                                                            <form action="/batchmedis/hapus/<?= $batch['no_batch'] ?>/<?= $batch['no_faktur'] ?>/<?= $batch['id_barang_medis'] ?>" method="POST">
                                                                <?= csrf_field() ?>
                                                                <div class="w-full sm:flex justify-center">
                                                                    <input type="hidden" name="_method" value="DELETE">
                                                                    <button onclick="closeModal('modelConfirm-<?= $batch['no_batch'] . $batch['no_faktur'] . $batch['id_barang_medis'] ?>')" class="w-full text-white bg-red-600 hover:bg-red-800 focus:ring-4 font-medium rounded-lg text-base inline-flex items-center justify-center px-3 py-2.5 text-center mr-2">
                                                                        Hapus
                                                                    </button>

                                                                    <a href="#" onclick="closeModal('modelConfirm-<?= $batch['no_batch'] . $batch['no_faktur'] . $batch['id_barang_medis'] ?>')" class="w-full text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 border border-gray-200 font-medium inline-flex items-center justify-center rounded-lg text-base px-3 py-2.5 text-center" data-modal-toggle="delete-user-modal">
                                                                        Batal
                                                                    </a>
                                                                </div>
                                                            </form>
