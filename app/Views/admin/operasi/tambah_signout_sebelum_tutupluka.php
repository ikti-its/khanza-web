...
foreach (['is_nama_tindakan_sesuai', 'is_kasa_lengkap', 'is_instrumen_lengkap', 'is_alat_tajam_lengkap', 'is_konfirmasi_bedah', 'is_konfirmasi_anestesi', 'is_konfirmasi_perawat'] as $boolField) {
