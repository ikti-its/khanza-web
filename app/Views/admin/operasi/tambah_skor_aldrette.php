...
$skorCategories = [
    ['key' => 'aktivitas',     'label' => 'Aktivitas',     'name' => 'skor_aktivitas',     'id_field' => 'id_aktivitas'],
    ['key' => 'respirasi',     'label' => 'Respirasi',     'name' => 'skor_respirasi',     'id_field' => 'id_respirasi'],
    ['key' => 'tekanan_darah', 'label' => 'Tekanan Darah', 'name' => 'skor_tekanan_darah', 'id_field' => 'id_td'],
    ['key' => 'kesadaran',     'label' => 'Kesadaran',     'name' => 'skor_kesadaran',     'id_field' => 'id_kesadaran'],
    ['key' => 'warna_kulit',   'label' => 'Warna Kulit',   'name' => 'skor_warna_kulit',   'id_field' => 'id_warna'],
];
?>
    ...
    <div class="bg-white rounded-xl shadow-sm p-4 sm:p-7 dark:bg-slate-900 border border-gray-100 dark:border-gray-800">
        ...
        <form action="<?= $modul_path . $form_action ?>" id="myForm" onsubmit="return validateForm()" method="post">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 my-5 pt-5">
                <p class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Penilaian Skor Aldrette</p>
                ...
                <?php foreach ($skorCategories as $cat): ?>
                    ...
                    <div class="mb-5 sm:block md:flex items-center">
                        ...
                        <select name="<?= $cat['name'] ?>" id="sel_<?= $cat['key'] ?>" onchange="recalculate()" required class="<?= $inputClass ?> lg:w-2/5">
                        ...
                        <span id="val_<?= $cat['key'] ?>" class="text-sm font-bold text-gray-900 dark:text-white ml-2 w-6 text-center">-</span>
                    </div>
                <?php endforeach; ?>
...
<script>
    // ── Skor Aldrette ──────────────────────────────────────────────────────────
    const SKOR_KEYS = ['aktivitas', 'respirasi', 'tekanan_darah', 'kesadaran', 'warna_kulit'];
    const THRESHOLD = 8;
    ...
    function recalculate() {
        ...
        if (allSelected) {
            ...
            narasiEl.textContent  = boleh
                ? 'Pasien bisa dipindahkan ke ruang perawatan bila skor minimal 8'
