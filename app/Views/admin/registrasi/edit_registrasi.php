...
<div class="max-w-[85rem] py-6 lg:py-3 px-8 mx-auto">
    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
        ...
        <form action="<?= site_url('registrasi/submitedit/' . $registrasi['nomor_reg']) ?>" id="myForm" onsubmit="return validateForm()" method="post">
            <?= csrf_field() ?>

            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 md:mb-0 text-sm text-gray-900 dark:text-white md:w-1/4">Nomor Registrasi</label>
                <input type="text" name="nomor_reg" value="<?= $registrasi['nomor_reg'] ?>" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" maxlength="80" required readonly>
                <label class="block mt-5 md:my-0 md:ml-10 mb-2 text-sm text-gray-900 dark:text-white w-1/5">Nomor Rawat</label>
                <input name="nomor_rawat" value="<?= $registrasi['nomor_rawat'] ?>" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required readonly>
            </div>

            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 md:mb-0 text-sm text-gray-900 dark:text-white w-1/5 lg:w-1/4">Tanggal</label>
                <input type="date" name="tanggal" value="<?= $registrasi['tanggal'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" maxlength="80" required>
                <label class="block mt-5 md:my-0 md:ml-10 mb-2 text-sm text-gray-900 dark:text-white w-1/5">Jam</label>
                <input type="time" name="jam" value="<?= $registrasi['jam'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" maxlength="80" required>
            </div>
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <div class="relative w-full md:w-1/4">
                    <input type="text" id="no_rkm_medis" name="no_rkm_medis" value="<?= $registrasi['nomor_rm'] ?>"
                ...
                <input id="nama_pasien" name="nama" value="<?= $registrasi['nama_pasien'] ?>"
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <select id="jenis_kelamin" name="jenis_kelamin" value="<?= $registrasi['jenis_kelamin'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
                ...
                <input id="umur" name="umur" value="<?= $registrasi['umur'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white">
            </div>
            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 md:mb-0 text-sm text-gray-900 dark:text-white md:w-1/4">
                    Poliklinik<span class="text-red-600">*</span>
                </label>
                <select name="poliklinik" id="poliklinikSelect" value="<?= $registrasi['poliklinik'] ?>"
                    class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white"
                    required>
                ...
                <select name="kode_dokter" id="dokterSelect" value="<?= $registrasi['nama_dokter'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <select name="hubungan_penanggung_jawab" id="hubungan_pj" value="<?= $registrasi['hubungan_pj'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <input type="text" id="alamat_pj" name="alamat_penanggung_jawab" value="<?= $registrasi['alamat_pj'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white">
                ...
                <input name="nomor_telepon" id="no_telp" value="<?= $registrasi['no_telepon'] ?>" class=" border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white">
            </div>
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <input type="number" name="biaya_registrasi" value="<?= $registrasi['biaya_registrasi'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" placeholder="0" v required>
