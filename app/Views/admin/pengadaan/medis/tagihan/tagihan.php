    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
        ...
        <form action="/submittambahtagihanmedis" method="post">
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <input type="text" name="idpenerimaan" value="<?= $penerimaan_data['no_faktur'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white">
            </div>
            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 md:mb-0 text-sm text-gray-900 dark:text-white md:w-1/4">Tanggal Bayar</label>
                <input type="date" name="tglbayar" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white">
            </div>
            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 md:mb-0 text-sm text-gray-900 dark:text-white md:w-1/4">Pegawai</label>
                <select name="pegawaitagihan" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white">
                    <option value="">-</option>
                                    ...
                                    <?php foreach ($pesanan_data as $pesanan) { ?>
                                        <tr>
                                            <td class="align-middle p-1 text-center">
                                                <input type="number" value="<?= $pesanan['jumlah_pesanan'] ?>" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]" name="" readonly />
                                            </td>
                                            <td class="align-middle p-1">
                                                <input type="text" step="any" value="<?php foreach ($medis_data as $medis) {
                                                                                        ...
                                                                                        } ?>" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]" name="" readonly />
                                            </td>
                                            <td class="align-middle p-1">
                                            ...
                                            <td class="align-middle p-1">
                                                <input type="text" step="any" value="<?= $pesanan['harga_satuan_pemesanan'] ?>" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]" name="" readonly />
                                            </td>
                                            <td class="align-middle p-1 text-right">
                                                <input type="text" value="<?= $pesanan['total'] ?? 'Belum ada total' ?>" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]" name="" readonly />
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                                        ...
                                        if ($pemesanan['id_pengajuan'] === $penerimaan_data['id_pengajuan']) { ?>
                                            <tr class="pt-5">
                                                ...
                                                <th class="p-1 pt-2 text-right" colspan="4">
                                                    Discount (%)
                                                    <input type="number" value="<?=$pemesanan['diskon_persen']?>" step="any" name="diskonpersen" class="text-center border w-[20%] rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]">
                                                </th>
                                                <th class="p-1 pt-2 text-right">
                                                    <input type="text" value="<?=$pemesanan['diskon_jumlah']?>" class="w-full border text-center rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]" name="diskonjumlah">
                                                </th>
                                            </tr>
                                            <tr>
                                                <th class="p-1 text-right" colspan="4">Tax Inclusive (%)
                                                    <input type="number" value="<?=$pemesanan['pajak_persen']?>" step="any" name="pajakpersen" class=" text-center border w-[20%] rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]">
                                                </th>
                                                <th class="p-1 text-right">
                                                    <input type="text" value="<?=$pemesanan['pajak_jumlah']?>" class="w-full border text-center rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]" name="pajakjumlah">
                                                </th>
                                            </tr>
                                            <tr>
                                                <th class="p-1 text-right" colspan="4">Materai</th>
                                                <th class="p-1 text-right">
                                                    <input type="text" value="<?=$pemesanan['materai']?>" class="w-full border text-center rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]" name="materai">
                                                </th>
                                            </tr>
                                            <tr>
