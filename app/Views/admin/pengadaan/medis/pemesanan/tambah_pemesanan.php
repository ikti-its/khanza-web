                                    ...
                                    <tbody class="tabelbodypesanan divide-y divide-gray-200 dark:divide-neutral-700">
                                        <tr>
                                            <td class="align-middle p-1 text-center">
                                                <input type="number" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" name="" />
                                            </td>
                                            <td class="align-middle p-1">
                                                <input type="text" step="any" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" name="" />
                                            </td>
                                            <td class="align-middle p-1">
                                                <input type="text" step="any" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" name="" />
                                            </td>
                                            <td class="align-middle p-1">
                                                <input type="text" id="harga" step="any" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" name="" />
                                            </td>
                                            <td class="align-middle p-1 text-right">
                                                <input type="text" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" value="" name="" />
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="p-1 text-right">
                                                <input type="hidden" value="" class="text-center w-full border border-gray-300" name="diskonjumlahpengajuan">
                                                <input type="text" value="" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" name="diskonjumlahpemesanan">
                                            </th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th class="p-1 text-right">
                                                <input type="hidden" value="" class="text-center w-full border border-gray-300" name="pajakjumlahpengajuan">
                                                <input type="text" value="" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" name="pajakjumlahpemesanan">
                                            </th>
                                        </tr>
                                        <tr>
                                            <th class="p-1 text-right" colspan="4">Materai</th>
                                            <th class="p-1 text-right">
                                                <input type="hidden" value="" class="text-center w-full border border-gray-300" name="materaipengajuan">
                                                <input type="text" value="" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" name="materaipemesanan">
                                            </th>
                                        </tr>
                                        <tr>
