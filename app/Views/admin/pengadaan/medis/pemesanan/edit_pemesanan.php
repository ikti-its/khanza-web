...
<div class="max-w-[85rem] py-6 lg:py-3 mx-auto">
    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
        ...
        <form action="/submiteditpemesananmedis/<?= $pemesanan_data['id'] ?>" method="post" onsubmit="return validateForm()">
        <?= csrf_field() ?>   
        <input type="hidden" value="3" name="status">
            ...
            <div class="sm:block md:flex items-center">
                ...
                <input type="hidden" name="idpengajuan" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" value="<?= $pengajuan_data['id'] ?>">
                <input type="text" name="" class="border bg-[#F6F6F6] cursor-default text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" value="<?= $pengajuan_data['nomor_pengajuan'] ?>" readonly required>
            ...
            <div id="dateError" class="mt-2 hidden">
                ...
                <div class="flex items-center text-red-500 text-sm">
                    ...
                    </svg> Tanggal pemesanan harus dari tanggal pemesanan yang dilakukan atau setelahnya.
                </div>
            </div>
            <div class="mt-5 sm:block md:flex items-center">
                <label class="block mb-2 md:mb-0 text-sm text-gray-900 dark:text-white md:w-1/4">Nomor Pemesanan</label>
                <input type="text" name="nopemesanan" class="border bg-[#F6F6F6] cursor-default text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" value="<?= $pemesanan_data['no_pemesanan'] ?>" readonly required>
            </div>
            <div class="mt-5 sm:block md:flex items-center">
                                                    ...
                                                    foreach ($medis_data as $barang_medis) {
                                                        ...
                                                        foreach ($optionbarang_medis as $barang_medisid => $barang_medisnama) {
                                                            if ($barang_medisid === $pesanan['id_barang_medis']) {
                                                                echo '<input type="text" step="any" value="' . $barang_medisnama . '" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6] cursor-default" name="" readonly required/>';
                                                            }
                                                        }
                                                    }
                                                    ?>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th class="p-1 text-right">
                                                <input type="number" min="0" value="<?= $totalsblmpajak ?>" step="any" name="totalsblmpajak" class=" text-center border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6]" readonly required>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th class="p-1" style="text-align: right;" colspan="7">Pajak (%)
                                                <input type="number" min="0" value="<?= $pemesanan_data['pajak_persen'] ?>" step="any" name="pajakpersenpemesanan" class=" text-center border w-[15%] rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" required>
                                            </th>

                                            <th class="p-1 text-right">
                                                <input type="number" min="0" value="<?= $pemesanan_data['pajak_jumlah'] ?>" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#F6F6F6] cursor-default" name="pajakjumlahpemesanan" readonly required>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th class="p-1" style="text-align: right;" colspan="7">Materai</th>
                                            <th class="p-1 text-right">
                                                <input type="number" min="0" value="<?= $pemesanan_data['materai'] ?>" class="text-center w-full border rounded-[0.5rem] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border-[#DCDCDC] bg-[#FDFDFD]" name="materaipemesanan" required>
                                            </th>
                                        </tr>
                                        <tr>
