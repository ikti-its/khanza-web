                                            ...
                                            <td>
                                                <div class="px-6 py-3">
                                                    <div class="flex items-center gap-x-3 text-start">
                                                        <span class="block text-sm font-semibold text-gray-800 dark:text-gray-200"><?= $pemesanan['tanggal_pesan'] ?? '-' ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="px-6 py-3">
                                                    <span class="text-start block text-sm font-semibold text-gray-800 dark:text-gray-200" data-hs-overlay="#hs-vertically-centered-scrollable-modal-<?= $pengajuan['id'] ?>"><?= $pengajuan['nomor_pengajuan'] ?? '-' ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="px-6 py-3">
                                                    <span class="text-start block text-sm font-semibold text-gray-800 dark:text-gray-200" data-hs-overlay="#hs-vertically-centered-scrollable-modal-<?= $pengajuan['id'] ?>"><?= $pemesanan['no_pemesanan'] ?? '-' ?></span>
                                                </div>
                                            </td>
                                                            ...
                                                            <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
                                                                ...
                                                                <div class="p-6 pt-0 text-center">
                                                                    ...
                                                                    <div class="w-full sm:flex justify-center">
                                                                        <a href="/hapuspemesananmedis/<?= $pemesanan['id'] ?>" onclick="closeModal('modelConfirm')" class="w-full text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center justify-center px-3 py-2.5 text-center mr-2">
                                                                            Hapus
                                                                        </a>
