    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
        ...
        <form action="<?= base_url('pemberianobat/submitedit') ?>" id="myForm" onsubmit="return validateForm()" method="post">
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <input name="nomor_rawat" value="<?=$pemberianobat['nomor_rawat'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" required>
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <select name="kelas" id="kelasSelect" value="<?=$pemberianobat['kelas'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white">
                    <?php
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <select id="obatSelect" name="kode_obat" value="<?=$pemberianobat['kode_obat'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
...
>
    <?= esc($obat['nama_obat']) ?>
                ...
                <input name="jumlah" value="<?=$pemberianobat['jumlah'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
            </div>
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <input name="gudang" value="<?=$pemberianobat['gudang'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
                <label class="block mt-5 md:my-0 md:ml-10 mb-2 text-sm text-gray-900 dark:text-white w-1/5">No Batch</label>
                <input name="no_batch" value="<?=$pemberianobat['no_batch'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
            </div>

            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 text-sm text-gray-900 dark:text-white md:w-1/4">No Faktur</label>
                <input name="no_faktur" value="<?=$pemberianobat['no_faktur'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
                <label class="block mt-5 md:my-0 md:ml-10 mb-2 text-sm text-gray-900 dark:text-white w-1/5">Tanggal Beri</label>
                <input name="tanggal_beri" value="<?=$pemberianobat['tanggal_beri'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
            </div>

            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 text-sm text-gray-900 dark:text-white md:w-1/4">Jam Beri</label>
                <input name="jam_beri" value="<?=$pemberianobat['jam_beri'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
                <label class="block mt-5 md:my-0 md:ml-10 mb-2 text-sm text-gray-900 dark:text-white w-1/5">Total</label>
                <input name="total" id="totalObat" value="<?=$pemberianobat['total'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" readonly>
            </div>
