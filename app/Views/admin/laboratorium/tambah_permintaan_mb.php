        ...
        <form action="<?= $modul_path . $form_action ?>" id="myForm" onsubmit="return validateForm()" method="post">
            ...
            <div class="mb-5 mt-4">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <button type="button"
                            onclick="open_modalItemPemeriksaanLab(<?= ID_KATEGORI_MB ?>, 'Pilih Item Mikrobiologi')"
                    ...
                    <table class="w-full text-sm text-gray-700 dark:text-gray-300">
                        <thead style="background-color: #E6F2EF;" class="text-gray-800 font-semibold">
                            <tr>
                                ...
                                <th class="p-3 border text-left dark:border-gray-700">Nama Item / Parameter</th>
                                <th class="p-3 border text-left dark:border-gray-700">Satuan</th>
                                <th class="p-3 border text-left dark:border-gray-700">Nilai Rujukan</th>
