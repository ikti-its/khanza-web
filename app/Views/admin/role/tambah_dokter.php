    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
        ...
        <form action="<?= $modul_path . $form_action ?>" id="myForm" onsubmit="return validateForm()" method="post">
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <input type="text" name="kode_dokter" value="<?= $val('kode_dokter') ?>" required data-label="Kode Dokter"
                       maxlength="20" class="<?= $editClass ?> lg:w-1/4">
            ...
            <!-- Spesialis -->
            <div class="mb-5 sm:block md:flex items-center">
                <label class="<?= $labelLeft ?>">Spesialis <span class="text-red-600">*</span></label>
                <input type="text" name="spesialis" value="<?= $val('spesialis') ?>" required data-label="Spesialis"
                       maxlength="60" class="<?= $editClass ?> lg:w-1/4">
            </div>
