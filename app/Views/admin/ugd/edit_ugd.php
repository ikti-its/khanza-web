    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
        ...
        <form action="<?= site_url('ugd/submitedit/' . $ugd['nomor_reg']) ?>" onsubmit="return validateForm()" method="post">
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <select name="poliklinik" id="poliklinikSelect" value="<?= $ugd['poliklinik'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
                ...
                <select name="kode_dokter" id="dokterSelect" value="<?= $ugd['dokter_dituju'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full md:w-1/4 dark:border-gray-600 dark:text-white" required>
