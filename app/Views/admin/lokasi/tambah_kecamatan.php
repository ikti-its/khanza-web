        ...
        <form action="<?= $modul_path . $form_action ?>" id="myForm" method="post">
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <div class="w-full lg:w-1/4">
                    <input type="text" name="id_kec_lokal" id="id_kec_lokal" value="<?= $baris['id_kec_lokal'] ?? '' ?>" required
                ...
                <label class="block mt-5 md:my-0 md:ml-10 mb-2 text-sm text-gray-900 dark:text-white w-1/5">
                    Nama Kecamatan<span class="text-red-600">*</span>
                </label>
                <input type="text" name="nama_kecamatan" id="nama_kecamatan" value="<?= $baris['nama_kecamatan'] ?? '' ?>" required
                       maxlength="30"
