...
<div class="max-w-[85rem] py-6 lg:py-3 px-8 mx-auto">
    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
        ...
        <form action="<?= site_url('ambulans/submitedit/' . $ambulans['no_ambulans']) ?>" method="POST">
            <?= csrf_field() ?>

            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 md:mb-0 text-sm text-gray-900 dark:text-white md:w-1/4">Nomor Ambulans</label>
                <input type="text" name="no_ambulans" value="<?= $ambulans['no_ambulans'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" maxlength="80" required>
            </div>
            ...
            <div class="mb-5 sm:block md:flex items-center">
                ...
                <input type="text" name="status" value="<?= $ambulans['status'] ?>" class="border border-gray-300 text-gray-900 text-sm rounded-lg p-2 w-full lg:w-1/4 dark:border-gray-600 dark:text-white" maxlength="80" required>
            </div>
