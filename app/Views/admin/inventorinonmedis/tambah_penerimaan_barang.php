...
<div class="max-w-[85rem] py-6 lg:py-3 px-8 mx-auto">
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
        ...
        <form action="<?= $modul_path . $form_action ?>" id="myForm" onsubmit="return validateForm()" method="post">
            ...
            <!-- No. Pengadaan (select) + Penerima (modal) -->
            <div class="mb-5 sm:block md:flex items-center">
                <label class="block mb-2 md:mb-0 text-sm text-gray-900 dark:text-white md:w-1/4">
                    No. Pengadaan<span class="text-red-600">*</span>
                </label>
                <select name="id_pengadaan_select" id="id_pengadaan_select"
                        onchange="onPengadaanChange(this.value)"
...
<script>
    function onPengadaanChange(idPengadaan) {
        ...
        loadPengadaanItems(idPengadaan);
    }
