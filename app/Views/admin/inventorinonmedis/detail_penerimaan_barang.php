    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-7 dark:bg-slate-900 dark:border-gray-800">
        ...
        <div class="space-y-1">
            ...
            <div class="sm:block md:flex items-center py-3">
                ...
                <span class="block mt-4 md:my-0 md:ml-10 mb-1 text-sm font-medium text-gray-500 dark:text-gray-500 md:w-1/4">Tanggal Penerimaan</span>
                <div class="w-full lg:w-1/4">
            ...
            <div class="sm:block md:flex items-center py-3">
                ...
                <span class="block mt-4 md:my-0 md:ml-10 mb-1 text-sm font-medium text-gray-500 dark:text-gray-500 md:w-1/4">Penerima</span>
                <div class="w-full lg:w-1/4">
            ...
            <div class="sm:block md:flex items-center py-3">
                ...
                <span class="block mt-4 md:my-0 md:ml-10 mb-1 text-sm font-medium text-gray-500 dark:text-gray-500 md:w-1/4">No. Masuk</span>
                <div class="w-full lg:w-1/4">
                    <span class="text-sm font-semibold text-gray-900 dark:text-white"><?= esc($baris['no_masuk'] ?? '-') ?></span>
                </div>
            </div>
