    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-7 dark:bg-slate-900 dark:border-gray-800">
        ...
        <div class="space-y-1">
            ...
            <div class="sm:block md:flex items-center py-3">
                ...
                <span class="block mt-4 md:my-0 md:ml-10 mb-1 text-sm font-medium text-gray-500 dark:text-gray-500 md:w-1/4">Tanggal Pengadaan</span>
                <div class="w-full lg:w-1/4">
            ...
            <div class="sm:block md:flex items-center py-3">
                ...
                <span class="block mt-4 md:my-0 md:ml-10 mb-1 text-sm font-medium text-gray-500 dark:text-gray-500 md:w-1/4">Suplier</span>
                <div class="w-full lg:w-1/4">
                    <span class="text-sm font-semibold text-gray-900 dark:text-white"><?= esc($baris['nama_suplier'] ?? '-') ?></span>
                </div>
            </div>
            ...
            <div class="sm:block md:flex items-center py-3">
                ...
                <div class="w-full lg:w-1/4">
                    <span class="inline-flex items-center py-1 px-2.5 rounded-full text-xs font-semibold" style="background-color: #FEF3C7; color: #92400E;">
                        <?= esc($baris['nama_status_pengadaan_barang'] ?? '-') ?>
                    </span>
                </div>
                <span class="block mt-4 md:my-0 md:ml-10 mb-1 text-sm font-medium text-gray-500 dark:text-gray-500 md:w-1/4">Total Harga</span>
                <div class="w-full lg:w-1/4">
                    <span class="text-sm font-semibold text-gray-900 dark:text-white"><?= number_format((float)($baris['total_harga'] ?? 0), 0, ',', '.') ?></span>
                </div>
            </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="text-slate-700 dark:text-slate-300">
                    ...
                    <tr class="border-t border-slate-100 dark:border-slate-700/50">
                        ...
                        <td class="py-2 text-right font-semibold"><?= number_format((float)($item['harga_satuan'] ?? 0), 0, ',', '.') ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
