...
<?= $this->include('components/modal/modalpenunjangutd') ?>
            ...
            <div class="mt-10 mb-5">
                <div class="flex justify-between items-center mb-3">
                    <h3 class="text-base font-semibold text-gray-900 dark:text-white">
                        Daftar BHP Non Medis Rusak<span class="text-red-600">*</span>
                    </h3>
                    <button type="button" onclick="open_modalPenunjangUtd()"
...
<script>
    ...
    function tambahBarisBhpPenunjangRusak(item) {
        ...
        row.className = "baris-penunjang border-b text-sm dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-slate-800/30";
        ...
        row.innerHTML = `
            ...
            <td class="p-3 text-center">
                <button type="button" onclick="hapusBarisBhpPenunjangRusak(this)" class="text-red-600 font-semibold hover:underline dark:text-red-400">
                    Hapus
                </button>
            </td>
        `;
    ...
    function hapusBarisBhpPenunjangRusak(button) {
    ...
    function validateForm() {
        ...
        const tbody = document.getElementById('komponenTableBody');
        const jumlahBaris = tbody.querySelectorAll('.baris-penunjang').length;
        if (jumlahBaris === 0) {
            alert("Gagal Menyimpan! Anda harus menambahkan minimal 1 item detail barang penunjang yang rusak.");
            return false;
        }
