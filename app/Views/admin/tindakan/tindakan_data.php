    ...
    <?php foreach ($tindakan_data as $i => $tindakan) : ?>
        <tr>
            ...
            <td class="h-px w-72 whitespace-nowrap">
                <div class="px-6 py-3">
                    <span class="text-center block cursor-default text-sm font-semibold text-gray-800 dark:text-gray-200"><?= $tindakan['biaya'] ?? 'N/A' ?></span>
                </div>
            </td>
            <td class="size-px whitespace-nowrap">
                <div class="px-3 py-1.5 text-center inline-flex">
                    ...
                    <div class="px-3 py-1.5">
                        <a href="/tindakan/edit/<?= $tindakan['nomor_rawat'] . '-' . $i ?>" class="gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-semibold">Ubah</a>
                    </div>
                    <div class="px-3 py-1.5">
                        <button class="gap-x-1 text-sm text-red-600 decoration-2 hover:underline font-semibold" onclick="openModal('modelConfirm-<?= $tindakan['nomor_rawat'] ?>')">Hapus</button>
                    </div>
                </div>
            </td>
        </tr>
