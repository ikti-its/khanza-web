...
<head>
    <meta charset="UTF-8">
    <title>Permintaan Pemeriksaan Lab MB</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        table.item-table .param-row td { background: #fafafa; font-size: 11px; padding: 3px 8px 3px 24px; color: #333; }
...
<div class="print-area">
    ...
    <div class="judul">PERMINTAAN PEMERIKSAAN LABORATORIUM MB</div>
    <hr>
