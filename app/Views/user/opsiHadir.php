...
<!-- Card Blog -->
<div class="flex justify-center items-center px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <!-- Grid -->
    <div class="grid sm:grid-cols-2 gap-6">
        <!-- Card -->
        <div class="h-72 w-[30rem] flex flex-col justify-center items-center bg-[#D6F9F3] rounded-xl">
        ...
        <!-- Card -->
        <div class="h-72 w-[30rem] flex flex-col justify-center items-center bg-[#0A2D27] rounded-xl">
