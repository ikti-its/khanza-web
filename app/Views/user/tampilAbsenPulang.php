                    ...
                    <form id="absenForm" method="post" action="/submittambahabsenpulang">
                            ...
                            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                                ...
                                <div class="sm:col-span-9">
                                    <label class="mt-2 relative inline-flex cursor-pointer items-center">
                                        <input id="switch-2" type="checkbox" class="peer sr-only" onclick="updateAction()" />
                                ...
                                <input type="hidden" id="id_jadwal" name="id_jadwal" value="<?= $kehadiran_data[0]['id'] ?>">
                        ...
                        <div class=" py-2 mb-2 mx-6 flex justify-end items-center">
                            ...
                            <div class="mt-6 flex justify-end gap-x-3">
                                ...
                                <button id="submitBtn" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#0A2D27] text-[#ACF2E7] hover:bg-teal-500 disabled:opacity-50 disabled:pointer-events-none">
                                    Ajukan
                                </button>
                            </div>
                            <!-- End Buttons -->
...
<script>
    function updateAction() {
        ...
        if (checkbox.checked) {
            form.action = '/submittambahabsenpulang?emergency=true';
        } else {
            form.action = '/submittambahabsenpulang';
        }
    }
</script>
