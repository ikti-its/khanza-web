...
<body>
    <div class="container mx-auto ml-0">
        ...
        <h1 class="text-6xl font-bold text-black mb-4">400</h1>
            <h1 class="text-6xl font-bold text-black mb-4">Oops! ada kesalahan pada permintaan Anda</h1>
            <p class="text-2xl text-black">Anda perlu login untuk mengakses halaman ini. Silahkan login dengan akun Anda dan coba lagi</p>
        </div>
