        ...
        <div class="w-screen h-screen">
            <div class="min-h-screen bg-gradient-to-b from-white via-[#D6F9F3] to-[#24A793] flex flex-col justify-center items-center relative">
                <div class="text-center z-10 pb-16">
                    <h1 class="text-6xl font-bold text-black mb-4">503</h1>
                    <h1 class="text-6xl font-bold text-black mb-4">Layanan tidak tersedia</h1>
                    <p class="text-2xl text-black">Layanan kami sedang tidak tersedia saat ini. Silakan coba lagi nanti</p>
                </div>
