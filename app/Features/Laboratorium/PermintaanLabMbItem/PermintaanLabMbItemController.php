...
final class PermintaanLabMbItemController extends ControllerTemplate
{
    ...
    private function fetchItemTerpilih(int $idPermintaanLab): array
    {
        $items = $this->model->db
            ...
            ->select([
                'mbi.id_permintaan_mb_item', 'mbi.id_item_pemeriksaan',
                'i.kode_periksa', 'i.nama_item', 'i.tarif',
            ])
        ...
        $parameters = $this->model->db
            ...
            ->select([
                'mbp.id_permintaan_mb_item', 'mbp.id_mb_parameter', 'mbp.id_parameter',
    ...
    private function fetchPermintaanLabHeaders(): array
    {
        return $this->model->db
            ...
            ->select([
                ...
                'p.nomor_rm', 'o.nama', 'd.kode_dokter', 'od.nama AS nama_dokter', 's.nama_status',
            ])
    ...
    public function create(): string|RedirectResponse
    {
        ...
        try {
            ...
            $this->insertItemsAndParameters($modelHeader->getInsertID(), $idItems, $idParameters, $modelItem, $modelParameter);
