    ...
    public function __construct()
    {
        parent::__construct(
            ...
            [
                ...
                [FORM_ONLY, REQUIRED, I::TEXT,  'ringkasan_klinik',       'Ringkasan Klinik'],
                [FORM_ONLY, REQUIRED, I::TEXT,  'pemeriksaan_fisik',      'Pemeriksaan Fisik'],
                [FORM_ONLY, REQUIRED, I::TEXT,  'pemeriksaan_diagnostik', 'Pemeriksaan Diagnostik'],
                [FORM_ONLY, REQUIRED, I::TEXT,  'diagnosa_pre_operasi',   'Diagnosa Pre-Operasi'],
                [FORM_ONLY, REQUIRED, I::TEXT,  'rencana_tindakan',       'Rencana Tindakan'],
                [FORM_ONLY, REQUIRED, I::TEXT,  'persiapan_khusus',       'Persiapan Khusus'],
                [FORM_ONLY, REQUIRED, I::TEXT,  'terapi_pre_operasi',     'Terapi Pre-Operasi'],
            ],
        );
    }
