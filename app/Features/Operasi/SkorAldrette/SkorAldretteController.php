...
final class SkorAldretteController extends ControllerTemplate
{
    ...
    public function create_page(): string
    {
        ...
        return view('admin/operasi/tambah_skor_aldrette', $this->buildViewData(
            $jadwal,
            [
                'id_jadwal'            => $idJadwal,
    ...
    public function update_page(int|string $id): string
    {
        ...
        return view('admin/operasi/tambah_skor_aldrette', $this->buildViewData($jadwal, $record, '/submitedit/' . $id));
    }
}
