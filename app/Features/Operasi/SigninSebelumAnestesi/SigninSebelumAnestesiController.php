...
final class SigninSebelumAnestesiController extends ControllerTemplate
{
    public function __construct()
    {
        parent::__construct(
            ...
            [
                ...
                [FORM_ONLY, REQUIRED, I::SELECT, 'is_resiko_aspirasi',        'Risiko Aspirasi'],
                [FORM_ONLY, REQUIRED, I::TEXT,   'rencana_aspirasi',          'Rencana Aspirasi'],
                [FORM_ONLY, REQUIRED, I::SELECT, 'is_resiko_hilang_darah',    'Risiko Hilang Darah'],
                [FORM_ONLY, REQUIRED, I::TEXT,   'jalur_iv_line',             'Jalur IV Line'],
                [FORM_ONLY, REQUIRED, I::TEXT,   'rencana_hilang_darah',      'Rencana Hilang Darah'],
                [FORM_ONLY, REQUIRED, I::INDEX,  'id_kesiapan_anestesi',      'Kesiapan Anestesi'],
                [FORM_ONLY, REQUIRED, I::TEXT,   'rencana_kesiapan_anestesi', 'Rencana Kesiapan Anestesi'],
            ],
        );
    }
    ...
    private function fetchOptions(): array
    {
        ...
        return [
            ...
            'kesiapan_anestesi' => $this->model->guarded_get($kesiapanBuilder, 'fetchOptions')->getResultArray(),
        ];
    }
