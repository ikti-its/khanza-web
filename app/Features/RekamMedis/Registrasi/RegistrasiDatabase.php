    ...
    public function __construct()
    {
        parent::__construct(
            ...
            [
                ...
                [
                    ['hubungan_pj'],
                    \App\Features\RekamMedis\HubunganPj\HubunganPjDatabase::class,
                    ['id_hubungan_pj'],
                ],
                [
                    ['jenis_bayar'],
                    \App\Features\RekamMedis\JenisBayar\JenisBayarDatabase::class,
                    ['id_jenis_bayar'],
                ],
                [
                    ['status_registrasi'],
                    \App\Features\RekamMedis\StatusRegistrasi\StatusRegistrasiDatabase::class,
                    ['id_status_registrasi'],
                ],
                [
                    ['status_rawat'],
                    \App\Features\RekamMedis\StatusRawat\StatusRawatDatabase::class,
                    ['id_status_rawat'],
                ],
                [
                    ['status_poli'],
                    \App\Features\RekamMedis\StatusPoli\StatusPoliDatabase::class,
                    ['id_status_poli'],
                ],
                [
                    ['status_bayar'],
                    \App\Features\RekamMedis\StatusBayar\StatusBayarDatabase::class,
                    ['id_status_bayar'],
                ],
            ],
            false,
