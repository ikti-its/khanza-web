...
namespace App\Features\RekamMedis\PoliRawatJalan;

use App\Core\Controller\ActionType as A;
use App\Core\Controller\ControllerTemplate;
use App\Core\Controller\InputType as I;
use App\Features\RekamMedis\Registrasi\RegistrasiModel;
...
final class PoliRawatJalanController extends ControllerTemplate
{
    ...
    public function list(): \CodeIgniter\HTTP\ResponseInterface
    {
        ...
        $builder = $this->model->db
            ...
            ->join('rekam_medis.status_poli sp', 'sp.id_status_poli = r.status_poli', 'left')
